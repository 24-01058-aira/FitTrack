# **FitTrack: A User-Centered Fitness and Progress Monitoring System🏋️**
...
✔️ Open any Java-supported IDE or command-line terminal.

✔️ Save the file as Main.java.

✔️ Compile the program: javac Main.java 

✔️ Run the program: java Main 
...
✔️ Choose a fitness goal

✔️ Select recommended workouts and food

✔️ Save, view, or delete routines
